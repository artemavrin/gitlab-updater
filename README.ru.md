...
> **Статус: фазы 0–3.** Работают и покрыты 192 офлайн-тестами обнаружение, планировщик, проверки готовности, бэкап, установка, ожидание миграций, состояние, resume, уведомления и работа в фоне. Меняет сервер только `run`, остальные команды read-only.
