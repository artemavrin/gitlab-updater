...
> **Статус: фазы 0–2.** Работают и покрыты 176 офлайн-тестами обнаружение, планировщик, проверки готовности, бэкап, установка, ожидание миграций, состояние и resume. Меняет сервер только `run`, остальные команды read-only.
