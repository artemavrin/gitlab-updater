...
for (const locale of LOCALE_IDS) {
  ...
  test(`каждое событие потока переводится — ${locale}`, () => {
    ...
    const extra = [
      ...
      { t: 'predownload:step', index: 2, of: 19, version: '16.3.9-ee' },
      { t: 'predownload:progress', index: 2, of: 19, version: '16.3.9-ee', percent: 37, what: null },
      { t: 'predownload:progress', index: 2, of: 19, version: '16.3.9-ee', percent: 37, what: 'gitlab-ee 16.3.9 · 1 234 MB' },
      { t: 'predownload:got', index: 2, of: 19, version: '16.3.9-ee', durationMs: 420_000 },
      { t: 'install:progress', version: '16.3.9-ee', stage: 'download', percent: 12, note: 'Retrieving file 1 of 1' },
      { t: 'install:progress', version: '16.3.9-ee', stage: 'install', percent: 40, note: 'Running dpkg' },
